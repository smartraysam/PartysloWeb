...
<html lang="en">
	...
	<head>
		...
		<title>Goeveni - My Dashbaord Change Password</title>
							...
							<div class="col-lg-3 col-md-5">								
								<div class="user-data full-width">
									...
									<div class="categories-items">
										...
										<a class="tab-item-1 active" href="my_dashboard_setting_change_pass.html">Change Password</a>																			
												...
												<div class="row">
													<div class="col-lg-6 col-md-12">													
														<div class="form-group">
															...
															<input class="payment-input" type="Password" placeholder="Enter Old Password">
														</div>	
														<div class="form-group">
															<label>New Password*</label>
															<input class="payment-input" type="Password" placeholder="Enter New Password">
														</div>
