@extends('layouts.app')
@section('title', 'Partyslo / '{{Auth::user()->name}})
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="my_dashboard_about.html">About</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="user-data full-width">
                            ...
                            <div class="about-dt-des">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent laoreet, dolor ut
                                    mollis rutrum, mauris arcu mollis lacus, eget imperdiet neque neque eget nisl. Nunc
                                    suscipit nulla dapibus nisi vestibulum tincidunt. Cras vestibulum vel ante et porttitor.
                                    Duis luctus consequat purus. Duis bibendum eget enim nec posuere. Aliquam purus lectus,
                                    blandit aliquam enim nec, viverra egestas libero. Suspendisse dictum neque et finibus
                                    posuere. </p>
                            </div>
                        </div>
                        <div class="user-data full-width">
