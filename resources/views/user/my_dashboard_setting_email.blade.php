...
<html lang="en">
	...
	<head>
		...
		<title>Goeveni - My Dashbaord Email Setting</title>
							...
							<div class="col-lg-3 col-md-5">								
								<div class="user-data full-width">
									...
									<div class="categories-items">
										...
										<a class="tab-item-1 active" href="my_dashboard_setting_email.html">Email Setting</a>																				
												...
												<div class="row">
													<div class="col-lg-6 col-md-12">													
														<div class="form-group">
															...
															<input class="payment-input" type="text" placeholder="Enter Old Email Address">
														</div>	
														<div class="form-group">
															<label>New Email Address*</label>
															<input class="payment-input" type="text" placeholder="Enter New Email Address">
														</div>
