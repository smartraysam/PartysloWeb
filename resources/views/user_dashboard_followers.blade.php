...
<html lang="en">
	...
	<head>
		...
		<title>Goeveni - Other Dashbaord Followers</title>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<ul class="nav nav-tabs">
								...
								<li class="nav-item">
									<a class="nav-link active" href="user_dashboard_followers.html">Followers <span class="badge badge-alrts">20</span></a>
								</li>
								<li class="nav-item">
